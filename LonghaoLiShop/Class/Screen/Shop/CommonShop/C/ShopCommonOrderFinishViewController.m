//
//  ShopCommonOrderFinishViewController.m
//  LonghaoLiShop
//
...
@interface ShopCommonOrderFinishViewController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, retain)UITableView *tableView;
@property (nonatomic, assign)int page;
@end

@implementation ShopCommonOrderFinishViewController
